...
class StandardButtonRegister extends StatefulWidget {
  ...
  @override
  State<StandardButtonRegister> createState() => StandardButtonRegisterState();

}

class StandardButtonRegisterState extends State<StandardButtonRegister> {
